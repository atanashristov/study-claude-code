...
### 02.34. Using Agent Skills as Commands

The skills show up as a slash (`/`) commands:

```txt
/modern-best-practice-react-components     Build clean, modern React components that apply common best practices and avoid common pitfalls like unnecessary state management
                                           or useEffect usage (project)
/modern-best-practice-nextjs               Build modern Next.js apps with App Router and best practices (project)
```

The **primary** task of these skills is that Claude can **discover and use** these skills.

We can *invoke as commands*. If the skill is just some knowledge, nothing will happen. We could write commands in the skill for Claude to execute. Again, this is not the primary use case.

### 02.35. Enhancing Skills & Adding Third-Party Skills
...
uilding custom skills is a powerful ability, because it allows you to really tailor your Claude Code experience and behavior to your specific project requirements and preferences.
